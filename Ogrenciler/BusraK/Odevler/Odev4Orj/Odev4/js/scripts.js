...
// class Shop {
//   constructor() {
//     this.request = new Request("http://localhost:3000/products");
//     this.basketRequest = new Request("http://localhost:3000/baskets");
//     this.ui = new UI();
...
//     if (
//       e.target.className === "paymentButton btn btn-primary btn-lg btn-block"
//     ) {
//       basketRequest.get().then((baskets) => {
//         baskets.forEach((basket) => {
//           request
...
// document.addEventListener("DOMContentLoaded", Shop.populateOptions);

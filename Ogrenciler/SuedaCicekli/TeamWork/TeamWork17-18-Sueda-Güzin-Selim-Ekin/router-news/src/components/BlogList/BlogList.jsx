  ...
  return (
    <div>
      ...
      <div className="text-center">
        ...
        <p className='p-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus ea ipsum dignissimos deleniti animi maxime, illum quibusdam aliquam architecto porro!</p>
      </div>

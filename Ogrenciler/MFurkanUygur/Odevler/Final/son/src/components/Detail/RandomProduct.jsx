    ...
    return (
        <div >
            <ProductCard className="card  my-2">
                <ProductImg src={`${currrentItem.image}`} className="card-img-top img-fluid" alt={`${currrentItem.title}`} />
                <div className="card-body my-0 py-0 w-100 ">
                    <ProductTitle className="card-title text-start m-0 p-0">{currrentItem.title}</ProductTitle>
                    <div className="row d-flex justify-content-between ">
                        <div className="d-flex">
                            <ProductSpecsTitle>Category:</ProductSpecsTitle>
                            <ProductSpecs>   {currrentItem.category}</ProductSpecs>
                        </div>

                    </div>
                    <ProductPrice className="text-start my-0 py-0">{currrentItem.price} $</ProductPrice>
                    {
                        userIsAdmin ?
                            <>
                                <CardButtonGroup>
                                        ...
                                        <div className="modal-dialog modal-lg">
                                            <div className="modal-content">
                                                <div className="modal-header">
                                                    <h1 className="modal-title fs-5" id={`${currrentItem.id}Label`}>Edit</h1>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            ...
                                                            <div className="d-flex flex-column">
                                                                ...
                                                                <input className="form-control" type="text" value={currrentItem.title} name="title" disabled />
                                                                <label htmlFor="price" className="text-start fw-semibold">Price</label>
                                                                <input className="form-control" type="text" value={currrentItem.price} name="price" disabled />
                                                                <label htmlFor="desc" className="text-start fw-semibold" >Description</label>
                                                                <textarea type="text" value={currrentItem.description} name="desc" disabled />
                                                                <label htmlFor="category" className="text-start fw-semibold">Category</label>
                                                                <input className="form-control" type="text" value={currrentItem.category} name="category" disabled />
                                                                <label htmlFor="img" className="text-start fw-semibold">Image</label>
                                                                <input className="form-control" type="text" value={currrentItem.image} name="img" disabled />
                                                                <label htmlFor="rate" className="text-start fw-semibold">Rate</label>
                                                                <input className="form-control" type="text" value={currrentItem.rating.rate} name="rate" disabled />
                                                                <label htmlFor="count" className="text-start fw-semibold">Count</label>
                                                                <input className="form-control" type="text" value={currrentItem.rating.count} name="count" disabled />
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-6">
                                    ...
                                    <CardButton onClick={() => { ifUserLogged() }} disabled={currrentItem.rating.count == 0 ? true : false} className="btn btn-primary">
                                        <img src={add} alt="" />
                                    </CardButton>
                                </CardButtonGroup>
                            </> :

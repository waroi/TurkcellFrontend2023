...
//     useEffect(() => {
//         fetchAllProduct().then(data => { setAllProducts(data), setUnique(data) })
//     }, []);

//     const uniqueCategories = [...new Set(unique?.map(item => item.category.toLowerCase()))];
...
//             return products;
//         }
//         return products.filter(product => selectedCategories.includes(product.category.toLowerCase()));
//     };
...
//     // const searchedProducts = filterProductsBySearchTerm(filteredProducts);
...
//                 sortedProducts.sort((a, b) => a.title.toLowerCase().localeCompare(b.title.toLowerCase()));
//                 break;
//             case 'zaSort': // İsim(Z-a)
//                 sortedProducts.sort((a, b) => b.title.toLowerCase().localeCompare(a.title.toLowerCase()));
//                 break;
//             case 'azCat': // Kategori(A-z)
//                 sortedProducts.sort((a, b) => a.category.toLowerCase().localeCompare(b.category.toLowerCase()));
//                 break;
//             case 'zaCat': // Kategori(Z-a)
//                 sortedProducts.sort((a, b) => b.category.toLowerCase().localeCompare(a.category.toLowerCase()));
//                 break;
//             default:
...
//                                         />
//                                         <label className="ms-2" htmlFor={`${i}`}>{catName}</label>
//                                     </div>
//                                 </li>
//                             </div>
//                         ))}
...
//                             <h4>Ürünler</h4>
//                             <select className="form-select w-25" aria-label="select" onChange={(e) => sortChange(e.target.value)}>
...
//                             <div className="col-6 col-lg-4" key={product.id}> <ListProducts product={product} /></div>
//                         ))}
//                     </div>
//                 </div>
//             </div>

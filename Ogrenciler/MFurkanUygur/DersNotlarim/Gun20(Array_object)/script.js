...
value = numbers.sort(() => 0.5 - Math.random())//Array elemanlarını random sıralama ()=>{0.5-Math.random()}
value = numbers.at(2)//ilgili indexteki elemanı verir
value = numbers.filter(a => a > 40)
value = numbers.find(a => a > 50)
value = numbers.findIndex(a => a > 40)

        ...
        {currency && (
          <>
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <img
                src="https://static.coinstats.app/coins/1646234478930.png"
                alt=""
                width={20}
              />
            </div>
            ...
            <div className="row">
              <div className="col-6">
                ...
                <div className="d-flex gap-2 align-items-center">
                  ...
                  {currency && currency.priceChange1d > 0 ? (
                    <button className="btn py-0 btn-success">
                      {currency.priceChange1d}
                    </button>
                  ) : (
                    <button className="btn py-0 btn-danger">
                      {currency.priceChange1d.toFixed(2)}
                    </button>
                  )}
                </div>
                <div className="d-flex gap-2 align-items-center">
                  <p className="ps-5 ms-5">{currency.volume}</p>
                  {currency && currency.priceChange1w > 0 ? (
                    <button className="btn py-0 btn-success">
                      {currency.priceChange1w}
                    </button>
                  ) : (
                    <button className="btn py-0 btn-danger">
                      {currency.priceChange1w.toFixed(2)}
                    </button>
                  )}
                </div>
              </div>
              <div className="col-6">{currency && currency.priceChange1h}</div>
            </div>
            <div className="col">
              <div className="row">

					...
					<div className="col-md-8">
						<div className="card-body text-start">
							...
							<p className="card-text">
								{activeUser.bio} | {activeUser.company}
							</p>
							<p className="card-text">Repo sayısı : {activeUser.public_repos}</p>
							<ul className="list-group">
								Son repolar :<li className="list-group">{userRepos[userRepos.length - 1].name}</li>
								<li className="list-group">{userRepos[userRepos.length - 2].name}</li>
							</ul>
							<button disabled className="btn btn-danger">
								takip edilen:{activeUser.following}
							</button>
							<button disabled className="btn btn-danger">
								takipçi:{activeUser.followers}
							</button>
						</div>
					</div>
					{/* <div className='col-md-4'>

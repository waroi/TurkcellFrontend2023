...
import HorizontalShotStyle from "./HorizontalShotStyle";
import Container from "../Container/Container";
import HorizontalShotMobile from "../../../assets/Horiztontal-shot-mobile.png";

const HorizontalShot = () => (
  <Container>
    <HorizontalShotStyle>
      <div className="horizontalShot">
        ...
        <img src={HorizontalShotMobile} alt="" className="horizontal d-lg-none" />
      </div>
    </HorizontalShotStyle>
  </Container>
);

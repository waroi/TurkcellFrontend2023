  ...
  const onSubmit = (values) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (existingUser) {
          toast.error("Email already exists:", existingUser.email);
        } else {
          axios
  ...
  return (
    <div className="container">
      <Form onSubmit={handleSubmit}>
        <h1 className="mb-4 title">SignUp Form</h1>
        <FormGroup>
        ...
        <div>
          ...
          {errors.profileImgUrl && (
            <div className="error">{errors.profileImgUrl}</div>
          )}
        </div>
        ...
        <ButtonStyle className="mt-3" type="submit">
          Submit
        </ButtonStyle>
      </Form>
      <ToastContainer />

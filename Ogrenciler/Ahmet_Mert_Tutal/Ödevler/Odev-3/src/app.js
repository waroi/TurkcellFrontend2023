...
const updateDateInput = document.querySelector("#updateDateInput");
...
function deletePost(e) {
    if (e.target.id === 'deletePost') {
        const id = e.target.closest(".postCard").getAttribute("id");
        request
            .delete(id)
            .then((message) => {
                console.log(message);
...
function updatePost(e) {
    if (e.target.id === 'updatePost') {
        ...
        const updateAuthor = document.querySelector("#updateAuthorInput");
        const updateTitle = document.querySelector("#updateTitleInput");
        const updateContent = document.querySelector("#updateContentInput");
        const updateCategory = document.querySelector("#updateCategoryInput");
        const updateUrl = document.querySelector("#updateUrlInput");
        const updateDate = document.querySelector("#updateDateInput");

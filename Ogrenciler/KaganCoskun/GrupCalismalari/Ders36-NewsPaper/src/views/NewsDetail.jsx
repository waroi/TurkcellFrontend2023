...
import {Container, Image, Title, Description, Url, NewsDate, NewsInfo, NewsSource} from "./newsDetailStyles"
...
console.log(news)
  ...
  return (
    ...
    <Container>
      ...
      <Url href={news?.url} target="_blank" rel="noreferrer"><button>Kaynak Habere Gidin</button></Url>
    </Container>
    </>
  )
}

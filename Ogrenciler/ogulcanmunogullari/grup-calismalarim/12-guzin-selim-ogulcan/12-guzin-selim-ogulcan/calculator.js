const calculator = {
 ...
 multiply: function () {
  this.secondNumber =
   this.secondNumber > 0 || this.secondNumber < 0 ? this.secondNumber : 1;
 ...
 divide: function () {
  this.secondNumber =
   this.secondNumber > 0 || this.secondNumber < 0
    ? this.secondNumber
    : Number(this.firstNumber) || 1;
 ...
 manual: function () {
  ...
  if (!isNaN(stringCheck)) {
   ...
   alert(
    'Lütfen içeriye harf girmeyiniz ve işlemler arasında boşluk bırakınız.',
   );
  }
 },

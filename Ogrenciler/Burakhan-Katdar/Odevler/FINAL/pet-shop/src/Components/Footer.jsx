  ...
  return (
    <div className="FooterSection">
      <Container>
        ...
        <Row className="FooterMid d-flex justify-content-between">
          <Col lg={4} className="FooterNav d-flex justify-content-between">
          ...
          <Col
            lg={2}
            className="FooterSocial d-flex justify-content-center gap-4"
          >
            <a href="#">
              <svg
        ...
        <hr />
        <Row className="FooterBottom justify-content-between">
          <Col lg={3}>© 2022 Monito. All rights reserved.</Col>

class UI {
    static addBookToUI(newBook) {
        ...
        previewButton.addEventListener('click', (e) => Book.previewBook(e));
        ...
        bookItem.addEventListener('click', (e) => Book.previewBook(e));
    ...
    static editBookInUI(updatedBook) {
    ...
    static deleteBookFromUI(target) {
        target.remove();
    }
    ...
    static filterBooks(authorValue, categoryValue) {
        ...
        if (!bookItemsDisplayed) {
            UI.showAlert('danger', 'No books found');
        }

...
function Book(name, genre, author, coverUrl, writtenDate) {
  this.id = Date.now();
  this.name = name;
  this.genre = genre;
  this.author = author;
...
UI.prototype.searchBook = function (e) {
...
UI.prototype.arrangeBook = function () {
...
UI.prototype.updateAuthorSelectOptions = function () {
...
UI.prototype.addBookToList = function (book) {
  ...
  bookImg.addEventListener("click", function () {
    const modalBookCover = document.getElementById("modalBookCover-" + book.id);
    const modalBookTitle = document.getElementById("modalBookTitle-" + book.id);
    ...
    const modalBookGenre = document.getElementById("modalBookGenre-" + book.id);
    ...
    modalBookWrittenDate.textContent = "Book Written Date: " + book.writtenDate;
  });
...
UI.prototype.showEditForm = function (book) {
...
UI.prototype.deleteBook = function (modal, bookLi, book) {
...
Storage.prototype.deleteBooks = function (id) {
  let bookList = this.getBooks();
...
Storage.prototype.saveAuthorsToLocalStorage = function () {
  localStorage.setItem("authors", JSON.stringify(authors));
};


// EventListeners and if bookList empty(addBooks to bookList)
